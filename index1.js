...
// Questions
var nodes = [{ "node": 1, "message": "Do you like Cakes in general", "yes": 5 , "no": 2 },
             { "node": 2, "message": "Do you like blueberries in your dessert?", "yes":3 , "no": 4 },
             { "node": 3, "message": "Do you like a colorful dessert?", "yes": 10, "no": 16 },
             { "node": 4, "message": "Do you like chocolate in your dessert?", "yes": 22, "no": 23 },
             { "node": 5, "message": "Do you like Cheese in your dessert?", "yes": 9, "no": 6 },
             { "node": 6, "message": "Do you like apples in your dessert?", "yes": 7, "no": 20 },
             { "node": 7, "message": "Do you like a pie for dessert ?", "yes": 11, "no": 21 },
             { "node": 9, "message": "Do you like a warm dessert?", "yes": 19, "no": 14 },
             { "node": 10, "message": "Do you like your dessert to be transparent", "yes": 15, "no": 13 },
             { "node": 22, "message": "Do you have sensitive teeth?", "yes": 18, "no": 17 },
             { "node": 23, "message": "Do you like a fruit in your dessert?", "yes": 25, "no": 26 },
             { "node": 26, "message": "Do you like some oats in your dessert?", "yes": 12, "no": 27 },

// Answers & descriptions
             { "node": 11, "message": "Your dessert is Apple Pie with cheese topping", "yes": 0, "no": 0, "description": "Apple pie with cheese is a comfort food and awesome. You work hard but like to relax and have fun." },
             { "node": 12, "message": "Your dessert is Oatmeal cookies.", "yes": 0, "no": 0, "description": "Oatmeal is very healthy. April 30th is National Oatmeal Cookie Day. You are a health freak."},
             { "node": 13, "message": "Your dessert is a Blueberry muffin", "yes": 0, "no": 0 , "description": "Blueberry muffin was sold as a tea time snack in London streets by muffin men. You are an outside person and like to travel."},
             { "node": 14, "message": "Your dessert is Cheese Cake.", "yes": 0, "no": 0 , "description": "Cheese cakes first originated in Greece and were served to athletes in Olympics. Maybe, you are a sports person or a big sports fan."},
             { "node": 15, "message": "Your dessert is Blueberry Jell-O.", "yes": 0, "no": 0 , "description": "Blueberry Jell-O is not a great source of vitamins or minerals. You seem to like eating junk food."},
             { "node": 16, "message": "You just like to eat Blueberries for dessert.", "yes": 0, "no": 0 , "description": "While blueberries are yummy, they leave blue stains on fingers, face and clothes. You like to be little bit messy but clean up later in your life."},
             { "node": 17, "message": "Your dessert is Chocolate Ice cream.", "yes": 0, "no": 0 , "description": "It takes about 50 licks to lick away one scoop of ice cream! July is national ice cream month. You like to do cool things on hot days. "},
             { "node": 18, "message": "Your dessert is Chocolate Milkshake", "yes": 0, "no": 0 , "description": "Consuming a serving of chocolate milkshake will do a great job of satisfying your hunger. You like to eat, drink and have fun."},
             { "node": 19, "message": "Your dessert is Cheese Blintzes cake.", "yes": 0, "no": 0 , "description": " Cheese Blintzes are a party favorite. You are a party animal."},
             { "node": 20, "message": "You just like to eat cheese for dessert.", "yes": 0, "no": 0 , "description": "It takes around 10 litres of milk to make 1 kilogram of hard cheese. You work really hard to get things done."},
             { "node": 21, "message": "You like to eat grilled apple with cheese honey for dessert.", "yes": 0, "no": 0 , "description": "This is a simple, healthy and a quick dessert. You like simple but elegant things in life."},
             { "node": 25, "message": "Your dessert is Apple Pie", "yes": 0, "no": 0, "description": "Apple pie is simple and a comfort food. You like to relax and have fun." },
             { "node": 27, "message": "Your desert is Rice Pudding", "yes": 0, "no": 0, "description": "Rice Pudding is simple and popular, but a heavy food. August 9th is Rice Pudding day. You like to relax, have fun and earn fame by being simple." },
...
var welcomeMessage = "Welcome to 'What's my dessert' game, are you ready to play?";
...
var playAgainMessage = "Say 'fun facts about the game' to hear a short description for this 'What's my dessert', or do you want to play again?";

// this is the help message during the setup at the beginning of the game
var helpMessage = "I will ask you some questions that will identify your dessert and say a fun and random facts about the dessert and you. Want to start now?";
